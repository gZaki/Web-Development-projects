...
<div class="container" style="padding-top:60px;"> 
	...
	<div class="row" style="direction:rtl;"> <!--Row-->
	...
	?>
		...
		<p class="description">الفئة:<?php echo htmlentities($Category); ?><br /> نشر في 
		...
		<br><br>
		<br><br>
		<span class="FieldInfo">الاراء</span>
<?php
...
<?php } ?>
		...
		<br>
		<span class="FieldInfo">شاركنا رئيك حول الموضوع</span>
...
<form action="FullPost.php?id=<?php echo $PostId; ?>" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
	<label for="Email"><span class="FieldInfo">البريد الالكتروني</span></label>
	<input class="form-control" type="email" name="Email" id="Email" placeholder="البريدالالكتروني">
	</div>
	<div class="form-group">
	<label for="commentarea"><span class="FieldInfo">رئيك</span></label>
	<textarea class="form-control" name="Comment" id="commentarea" placeholder="رئيك"></textarea>
	<br>
...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h2 class="panel-title">اخر المواضيع</h2>
	</div>
	<div class="panel-body background">
<?php
$ViewQuery="SELECT * FROM admin_panel WHERE category='365' ORDER BY id desc LIMIT 0,5";
$Execute=mysqli_query($DB,$ViewQuery);
while($DataRows=mysqli_fetch_array($Execute)){
	$Id=$DataRows["id"];
	$Title=$DataRows["title"];
