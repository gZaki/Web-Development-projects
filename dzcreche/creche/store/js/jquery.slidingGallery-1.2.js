...
(function($) {
    ...
    $.galleryUtility.Options = {
        ...
        zoomSpeed: 'fast',
        gutterWidth: 20,
        captionUpPath: 'img/blank.gif',
        captionUpWidth: 24,
        captionUpHeight: 17,
        captionUpID: 'captionArrowUp',
        captionDownPath: 'img/blank.gif',
        captionDownWidth: 24,
        ...
        captionStyle: 'background-color:white; color:black; opacity: 0.2; filter: alpha(opacity = 60); font-size: 16px; text-align:center;',
